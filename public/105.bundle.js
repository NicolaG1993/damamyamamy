...
var stripePromise = (0,stripe_esm/* loadStripe */.J)(undefined); // const PayPalButton = window.paypal.Buttons.driver("react", { React, ReactDOM });
...
function PaymentForm(_ref) {
  ...
  (0,react.useEffect)(function () {
    ...
    if (window.paypal) {
      ...
      insertScriptElement({
        url: "https://www.paypal.com/sdk/js?client-id=".concat(undefined, "&currency=").concat(ppValues.currency, "&disable-funding=").concat(ppValues.disablefunding, "&locale=").concat(ppValues.locale),
