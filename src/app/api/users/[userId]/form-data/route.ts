...
import { fetchUserFormData } from "@/database/utils/fetchUser";
...
export async function GET(
    ...
    try {
        const user: UserFormData = await fetchUserFormData(client, userId);
        ...
        console.error("Errore API fetchUserFormData:", error);
