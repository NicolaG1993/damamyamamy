    ...
    return (
        <div className={"document-comp"}>
            ...
            <div className={"document-text-wrap"}>
                <h3>
                    DA MAMY A MAMY SRL utilizza cookies per migliorare
                    l’esperienza dell’utente, raccomandiamo di accettarne
                    l’utilizzo per sfruttare a pieno la navigazione
                </h3>
                <p>
                    I Dati personali del Cliente al momento della creazione del
                    conto cliente, sono destinati alla società DA MAMY A MAMY
                    SRL e si riserva inoltre il diritto di trasmettere le
                    informazioni a terzi, previo accordo dato dal Cliente. Il
                    Cliente che si iscrive sul Sito, s&apos;impegna a fornire a
                    DA MAMY A MAMY SRL informazioni veritiere e corrette. Le
                    informazioni raccolte sono necessarie alla gestione della
                    relazione commerciale tra ogni Cliente e la società DA MAMY
                    A MAMY SRL. Nel quadro dell&apos;emissione dell&apos;ordine,
                    le informazioni comunicate dal Cliente sono indispensabili
                    per l&apos;evasione e la consegna dell&apos;ordine, nonché
                    per la preparazione della fattura. L&apos;assenza di queste
                    informazioni, comporta come conseguenza l&apos;annullamento
                    dell&apos;ordine. DA MAMY A MAMY SRL s&apos;impegna a
                    ...
                    trasmessi a DA MAMY A MAMY SRL da ogni Cliente e ciò nel
                    rispetto delle disposizioni di legge e applicabili. Il
                    Cliente riconosce il diritto di DA MAMY A MAMY SRL di
                    registrare ogni dato relativo all&apos;uso del conto,
                    soprattutto ogni informazione relativa agli acquisti. Il
                    Cliente riconosce di accettare che le operazioni ed il
                    trattamento automatizzato dei dati Personali effettuato al
                    momento della creazione del proprio conto cliente e dopo la
                    creazione dello stesso, potranno essere effettuati da DA
                    MAMY A MAMY SRL e/o ogni altro partner contrattualmente
                    legato direttamente o indirettamente a DA MAMY A MAMY SRL.
                    Le informazioni raccolte hanno come finalità di rendere
                    possibile gli acquisti e di proporre promozioni, offerte
                    commerciali e informazioni relative ai prodotti. Queste
                    offerte e informazioni saranno inviate al Cliente a
                    discrezione di DA MAMY A MAMY SRL, previo accordo dato dalla
                    cliente, DA MAMY A MAMY SRL si riserva anche il diritto di
                ...
                <p>
                    ...
                    MAMY SRL e ciò dopo verifica condotta DA MAMY A MAMY SRL -
                    se ritenuto opportuno - dell&apos;identità del Cliente
                    tramite documento d&apos;identità valido.
                </p>
                <p>
                ...
                <address>
                    DA MAMY A MAMY SRL <br />
                    Vicolo Teatro, 4 37010
                </address>
                <address>CAVAION VERONESE (VR)</address>
                <address>E-mail: customerservice@damamyamamy.it </address>
                <address>Tel: +39-347-9792-644 </address>
                <p>
                    DA MAMY A MAMY SRL propone al Cliente di ricevere via e-mail
                ...
                <p>
                    ...
                    sono destinate a DA MAMY A MAMY SRL.
                </p>
                <div className="end-paragraph"></div>
                ...
                <p>
                    ...
                    DA MAMY A MAMY SRL non potrà essere ritenuta responsabile
                    del malfunzionamento del Sito o della diminuita efficacia
