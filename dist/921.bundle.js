(self["webpackChunkdamamyamamy"] = self["webpackChunkdamamyamamy"] || []).push([[921],{
...
;// CONCATENATED MODULE: ./src/client/lib/axios.js

var instance = axios_default().create({
  xsrfCookieName: "mytoken",
  xsrfHeaderName: "csrf-token"
});
/* harmony default export */ const lib_axios = (instance);
  ...
  if (isFailed) {
    return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("p", {
        children: "Messaggio non inviato! C\xE9 stato un errore"
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(Button/* default */.Z, {
        page: "/",
        text: "Torna al sito",
        type: "internal"
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              nextStep(); //here -> using try catch and axios

              _context.prev = 1;
              _context.next = 4;
              return lib_axios.post("/api/contact", contactReq);
            ...
            case 9:
              ...
              console.log("err in /contact: ", _context.t0); //handle error
