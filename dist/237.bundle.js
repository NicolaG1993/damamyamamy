(self["webpackChunkdamamyamamy"] = self["webpackChunkdamamyamamy"] || []).push([[237],{
...
;// CONCATENATED MODULE: ./src/client/utils/useScrollPosition.js
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
function useScrollPosition() {
  var _useState = (0,react.useState)(window.scrollY),
      _useState2 = _slicedToArray(_useState, 2),
...
function StepA_slicedToArray(arr, i) { return StepA_arrayWithHoles(arr) || StepA_iterableToArrayLimit(arr, i) || StepA_unsupportedIterableToArray(arr, i) || StepA_nonIterableRest(); }

function StepA_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function StepA_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return StepA_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return StepA_arrayLikeToArray(o, minLen); }

function StepA_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function StepA_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function StepA_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function StepA(_ref) {
  ...
  var _useState = (0,react.useState)(contactReq || {}),
      _useState2 = StepA_slicedToArray(_useState, 2),
      values = _useState2[0],
      setValues = _useState2[1];

  var _useState3 = (0,react.useState)({}),
      _useState4 = StepA_slicedToArray(_useState3, 2),
      errors = _useState4[0],
...
var ContactMap = (0,loadable_esm/* default */.ZP)(function () {
  return __webpack_require__.e(/* import() */ 503).then(__webpack_require__.bind(__webpack_require__, 503));
});
function Contact() {
