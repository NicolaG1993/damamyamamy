...
function reducer() {
  ...
  switch (action.type) {
    case loadData_types/* LOAD_DATA */.Uy:
      {
        var data = action.payload; // console.log("LOAD_DATA: ", action.payload);
    ...
    case loadData_types/* GET_ITEM */.rt:
      {
        var selectedItem = action.payload; // let key = Number(action.payload.key);
    ...
    case loadData_types/* FETCH_HIGHEST_VALUE */.MD:
      {
        var _data2 = state.data; // console.log("FETCH_HIGHEST_VALUE data: ", data);

        var topValue;
        _data2 ? topValue = Math.max.apply(Math, _data2.map(function (element) {
          return element.price.raw; // FIXARE ? 🧨
        })) : topValue = 10; // console.log("FETCH_HIGHEST_VALUE topValue: ", topValue);
...
// EXTERNAL MODULE: ./src/client/redux/LoadCart/loadCart.types.js
var loadCart_types = __webpack_require__(7447);
;// CONCATENATED MODULE: ./src/client/redux/LoadCart/loadCart.reducer.js
function loadCart_reducer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function loadCart_reducer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { loadCart_reducer_ownKeys(Object(source), true).forEach(function (key) { loadCart_reducer_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { loadCart_reducer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function loadCart_reducer_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

/* eslint-disable indent */

var loadCart_reducer_INITIAL_STATE = {
  notAvailables: []
};
function loadCart_reducer_reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : loadCart_reducer_INITIAL_STATE;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case loadCart_types/* FETCH_CART */.ST:
      {
        var cart = action.payload; // console.log("FETCH_CART: ", action.payload);

        var addedItems = cart && cart.line_items.map(function (obj) {
          return {
            item_id: obj.id,
        ...
        return loadCart_reducer_objectSpread(loadCart_reducer_objectSpread({}, state), {}, {
          cart: cart,
          notAvailables: addedItems
        });
      }

    case loadCart_types/* HANDLE_CART */.Wt:
      {
        var _cart = action.payload.cart; // console.log("HANDLE_CART cart: ", cart);

        var _addedItems;

        if (_cart) {
          _addedItems = _cart.line_items.map(function (obj) {
            return {
              item_id: obj.id,
              product_id: obj.product_id
            };
        ...
        return loadCart_reducer_objectSpread(loadCart_reducer_objectSpread({}, state), {}, {
          cart: _cart,
          notAvailables: _addedItems
        });
      }

    case loadCart_types/* HANDLE_NEW_CART */.ol:
      {
        var newCart = action.payload; // console.log("HANDLE_NEW_CART newCart: ", newCart);
    ...
    case loadCart_types/* HANDLE_ERROR */.yA:
      {
        var error = action.payload.error;
        var actionType = action.payload.actionType; // console.log("HANDLE_ERROR error: ", error);
    ...
    case filterStore_types/* FILTER_BY_VALUE */.U_:
      {
        ...
        var filteredValues = state.originalState.filter(function (product) {
          ...
          return product.name.toLowerCase().includes(value) || product.categories[0] && product.categories[0].name.toLowerCase().includes(value);
    ...
    case filterStore_types/* FILTER_BY_CATEGORY */.gr:
      {
        ...
        if (_value === "") {
          ...
          _newState.filteredItems = state.filteredItems.filter(function (item) {
            return item.categories[0] && item.categories[0].name === _value && item.categories[0].id === valueID;
    ...
    case filterStore_types/* FILTER_BY_PRICE */.o6:
      {
        ...
        if (minPrice || maxPrice) {
          ...
          _newState2.filteredItems = _filteredValues; // newState.appliedFilters = {
...
;// CONCATENATED MODULE: ./src/client/redux/Checkout/checkout.reducer.js
function checkout_reducer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function checkout_reducer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { checkout_reducer_ownKeys(Object(source), true).forEach(function (key) { checkout_reducer_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { checkout_reducer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function checkout_reducer_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

/* eslint-disable indent */

var checkout_reducer_INITIAL_STATE = {};
function checkout_reducer_reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : checkout_reducer_INITIAL_STATE;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case checkout_types/* LOAD_CHECKOUT */._r:
      return checkout_reducer_objectSpread(checkout_reducer_objectSpread({}, state), {}, {
        error: false
      });

    case checkout_types/* CAPTURE_CHECKOUT */.Nx:
      {
        var incomingOrder = action.payload;
    ...
    case checkout_types/* HANDLE_ERROR */.yA:
      {
        var error = action.payload.error;
...
var rootReducer = (0,redux/* combineReducers */.UY)({
  ...
  loadCart: loadCart_reducer_reducer,
  checkout: checkout_reducer_reducer,
...
/* harmony export */   "_r": () => (/* binding */ LOAD_CHECKOUT),
/* harmony export */   "Nx": () => (/* binding */ CAPTURE_CHECKOUT),
/* harmony export */   "yA": () => (/* binding */ HANDLE_ERROR)
/* harmony export */ });
var LOAD_CHECKOUT = "LOAD CHECKOUT";
var CAPTURE_CHECKOUT = "CAPTURE CHECKOUT";
var HANDLE_ERROR = "HANDLE ERROR";
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ST": () => (/* binding */ FETCH_CART),
/* harmony export */   "Wt": () => (/* binding */ HANDLE_CART),
/* harmony export */   "ol": () => (/* binding */ HANDLE_NEW_CART),
/* harmony export */   "yA": () => (/* binding */ HANDLE_ERROR)
/* harmony export */ });
var FETCH_CART = "FETCH CART";
var HANDLE_CART = "HANDLE CART";
var HANDLE_NEW_CART = "HANDLE NEW CART";
var HANDLE_ERROR = "HANDLE ERROR"; // export const ADD_TO_CART = "ADD TO CART";
// export const REMOVE_FROM_CART = "REMOVE FROM CART";
// export const REFRESH_CART = "REFRESH CART";
...
/******/ __webpack_require__.O(0, [216], () => (__webpack_exec__(6981), __webpack_exec__(8575)));
